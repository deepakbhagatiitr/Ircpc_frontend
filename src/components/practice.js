        ...
        <aside className="flex flex-col w-64 h-full px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
          <a href="#" className="mx-auto ">
            <img
              ...
              src="https://ir.iitr.ac.in/EventsAbroad/images/IITR_Logo.png"
              alt=""
            ></img>
          </a>
          ...
          <div className="flex flex-col justify-between flex-1 mt-6">
            <nav>
              ...
              >
                ...
                <span className="mx-4 font-medium">Queries</span>
              </a>
            </nav>
          </div>
        </aside>
...
export default function Sidebar() {
  ...
  const { fullName, contactInformation } = userData.person;
  const { instituteWebmailAddress } = contactInformation;
  ...
  return (
    <aside className="flex flex-col w-64 h-full px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
      ...
      <div className="flex flex-col justify-between flex-1 mt-6">
        <nav>
          <Link href="/">
            <a className={`flex items-center px-4 py-2 text-gray-700 bg-gray-100 rounded-lg dark:bg-gray-800 dark:text-gray-200 ${router.pathname === '/' && 'bg-blue-500 text-white'}`}>
              {/* Add your icon here */}
              <span className="mx-4 font-medium">Applications</span>
            </a>
          </Link>
          ...
          <Link href="/patent">
            <a className={`flex items-center px-4 py-2 text-gray-700 bg-gray-100 rounded-lg dark:bg-gray-800 dark:text-gray-200 ${router.pathname === '/patent' && 'bg-blue-500 text-white'}`}>
              {/* Add your icon here */}
              <span className="mx-4 font-medium">Apply Patents</span>
            </a>
          </Link>
          <Link href="/stats">
            <a className={`flex items-center px-4 py-2 text-gray-700 bg-gray-100 rounded-lg dark:bg-gray-800 dark:text-gray-200 ${router.pathname === '/stats' && 'bg-blue-500 text-white'}`}>
              {/* Add your icon here */}
              <span className="mx-4 font-medium">Statistics</span>
            </a>
          </Link>
          <Link href="/query">
            <a className={`flex items-center px-4 py-2 text-gray-700 bg-gray-100 rounded-lg dark:bg-gray-800 dark:text-gray-200 ${router.pathname === '/query' && 'bg-blue-500 text-white'}`}>
              {/* Add your icon here */}
              <span className="mx-4 font-medium">Queries</span>
            </a>
          </Link>
